...
class Dashboard extends React.Component{
    ...
    poll = () => {
        ...
        fetch('https://events.dancemarathon.com/api/events/6266/donations?limit=5')
    ...
    render(){
        ...
        <Row style={{display: "inline-block"}}>
            <div className="countdown">
                <Countdown date={new Date("Mar 29, 2025 10:30:00")} daysInHours={true}/>
                <span style={{padding: 0}}> until PDM blastoff!</span>
            </div>
        </Row>
        {/* <Row>
            <div className="">
